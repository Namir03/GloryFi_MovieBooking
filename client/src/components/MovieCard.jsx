...
import timeFormat from "../lib/TimeFomat";
...
const MovieCard = ({ movie }) => {
    ...
    hover:-translate-y-1 transition duration-300 w-full max-w-[256px] mx-auto">
        ...
        object-right-bottom cursor-pointer"/>
            ...
            <div className="flex items-center justify-between mt-4 pb-3">
                <button onClick={() => { navigate(`/movies/${movie._id}`); scrollTo(0, 0) }}
                    className="px-4 py-2 text-xs bg-[rgb(255_0_0)] hover:bg-[rgb(34_34_34)]
            transition rounded-full font-medium cursor-pointer">
                    Buy Tickets
                </button>
                <p className="flex items-center gap-1 text-sm text-gray-400 mt-1 pr-1">
                    <StarIcon className="w-4 h-4 text-primary fill-[rgb(200_0_200)]" />
